...
<p class="hook">Lò nướng wafer ở 1200°C — oxy bên trong thoát ra ngoài. Hoặc bạn có thể đặt nó vào môi trường giàu oxy — oxy từ ngoài chảy vào bên trong. Cùng một nguyên tử Silicon, hai hướng đi hoàn toàn khác, và mỗi hướng sẽ làm thay đổi chất lượng wafer theo những cách khác nhau. Bạn cần loại nào?</p>

## Khuếch Tán, Cân Bằng, và Chiến Lược Điều Khiển

Hãy tưởng tượng các nguyên tử như những người di cư — họ lúc nào cũng cố gắng di chuyển từ nơi đông đúc sang nơi vắng vẻ, cho tới khi đông đúc ở mọi nơi. Nhưng ở wafer Silicon được nứng nóng, bạn có thể điều khiển họ đi ra ngoài hay đi vào trong bằng cách thay đổi môi trường xung quanh. Tùy thuộc vào loại wafer bạn cần — sạch hay bền — bạn sẽ chọn hướng khác nhau.
...
1. **Khuếch tán ngoài (outward diffusion):** Nguyên tử từ bên trong wafer thoát ra ngoài.
2. **Khuếch tán trong (inward diffusion):** Nguyên tử từ bên ngoài vào sâu vào wafer.
...
- Lớp này được gọi là **Denuded Zone** — vùng **bề mặt sạch khuyết tật**.
- Độ dày DZ: thường **50-100 μm** từ bề mặt vào.

#### Lợi Ích của DZ

- **Chất lượng wafer cải thiện:** Không có oxide precipitate gây tổn thương cơ học và ảnh hưởng điện.
...
**Khuếch tán trong** là quá trình nguyên tử từ **bên ngoài wafer** (từ lò, từ oxy, từ hydrogen) di chuyển **vào sâu vào wafer** trong quá trình xử lý nhiệt.
...
<QuickCheck
	client:visible
	question="Lớp Denuded Zone (DZ) được tạo ra bằng cách nào?"
	options={[
		{ label: "Oxy khuếch tán vào bề mặt wafer ở môi trường giàu oxy", correct: false },
		{ label: "Oxy khuếch tán ra khỏi wafer ở môi trường khí trơ với nhiệt độ cao", correct: true },
		{ label: "Bề mặt wafer được mài mỏng để loại bỏ oxy", correct: false },
	]}
	explanation="DZ được tạo bằng khuếch tán ngoài: xử lý ở 1200°C trong N₂ (không có oxy) → oxy bên trong thoát ra → bề mặt trở nên sạch khuyết tật."
/>
...
| **Ứng dụng** | Wafer logic, IC yêu cầu bề mặt sạch | Wafer công suất, Wafer bipolar |
