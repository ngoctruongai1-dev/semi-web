...
<p class="hook">Cấp ứng suất cực độ cho chip − nhiệt độ 150°C, điện áp cao, dòng điện lớn − như "tăng tốc" quá trình suy giảm. Những khuyết tật tiềm ẩn sẽ phát lộ trong vài giờ. Nhưng tại sao phải "hành hạ" chip để tìm ra những chip lỏi, khi kiểm tra bình thường không được sao?</p>

## Định Nghĩa

**Burn-in** là công đoạn "**cấp ứng suất (stress) mạnh mẽ − áp suất cao, điện áp cao, nhiệt độ cao − liên tục cho chip bán dẫn để buộc những khuyết tật tiềm ẩn phát lộ, từ đó chọn loại bỏ sản phẩm lỗi trước khi xuất xưởng**".
...
Tuy nhiên, những khuyết tật đó là **"bom nổi chậm"** − chúng chỉ chờ điều kiện xấu xuất hiện để phát lộ.

### 2. Gia Tốc Thời Gian Sự Cố (Accelerate Failure)

Burn-in **tạo điều kiện stress mạnh** để buộc khuyết tật:
...
<details>
<summary>Phương trình Arrhenius và gia tốc nhiệt</summary>

Tốc độ suy giảm chip tuân theo **phương trình Arrhenius**:

$$\text{Rate} \propto \exp\left(\frac{E_a}{kT}\right)$$

Nâng nhiệt độ từ 25°C lên 125°C có thể **gia tốc 100–1000 lần** quá trình suy giảm. Điều này có nghĩa 1 giờ burn-in ở 125°C tương đương với hàng trăm giờ hoặc hàng ngàn giờ sử dụng bình thường.
...
<QuickCheck
	client:visible
	question="Tại sao burn-in cần cấp ứng suất cao (nhiệt độ, điện áp) thay vì chỉ test bình thường?"
	options={[
		{ label: "Vì ứng suất cao làm chip tốt trở nên tốt hơn", correct: false },
		{ label: "Vì ứng suất cao gia tốc khuyết tật tiềm ẩn phát lộ, khiến chip yếu bị loại sớm trong nhà máy thay vì ở khách hàng", correct: true },
		{ label: "Vì test bình thường không bao giờ phát hiện được lỏi", correct: false },
	]}
	explanation="Burn-in không làm chip tốt trở nên tốt. Nó buộc chip yếu (có khuyết tật tiềm ẩn) phát lộ nhanh, để nhà máy có thể loại bỏ chúng trước khi ship cho khách hàng."
/>
...
**Burn-in không phải kiểm tra mà là "luyện tập tay não"** − nó khô quặng (sift out) những chip yếu đuối trước khi chúng gây hỏng hỏi cho khách hàng. Đây là **hành động tiên phòng** có giá trị cao trong bảo đảm chất lượng bán dẫn, đặc biệt với những sản phẩm quan trọng về độ tin cậy − nơi một chip lỏi có thể gây hậu quả tiền tỷ.
