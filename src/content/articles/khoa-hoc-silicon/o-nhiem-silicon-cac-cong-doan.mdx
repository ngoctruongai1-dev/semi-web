---
title: Ô Nhiễm Silicon Trong Các Công Đoạn
...
<p class="hook">Một hạt bụi nhỏ xíu, một vài nguyên tử sodium, hay một vi khuẩn trong nước rửa — tất cả chúng chỉ cần một chút thôi là đủ để "giết" cả triệu transistor trên một chip. Bạn không thể ngăn chặn ô nhiễm hoàn toàn, nhưng bạn phải biết nó đến từ đâu, làm sao để giảm, và khi nào cần "tái sinh" lại wafer bị ô nhiễm.</p>

## Tổng Quan

**Ô Nhiễm (Contamination)** là sự có mặt của các **tạp chất không mong muốn** trên wafer silicon. Một trong những **thách thức lớn nhất** của ngành bán dẫn hiện đại là kiểm soát ô nhiễm, vì ngay cả **những tạp chất ở mức vô cùng nhỏ** (ppb – phần tỷ) cũng có thể **hủy hoại toàn bộ thiết bị**.

## Bốn Loại Ô Nhiễm Chính

### 1. Hạt Vi Mô (Particles)

**Định Nghĩa**: Những **hạt rắn nhỏ** từ **nm (nanomet) đến μm (micromet)** – bụi, mảnh vỡ, hoặc sản phẩm phụ từ quá trình sản xuất.
...
- **Mùa Thu Lỗi**: Hạt vi mô **che phủ một phần pattern** trong photolithography — khi etch, hạt bảo vệ Si bên dưới → lại **lỗ trống** → **chuyên mạch IC bị ngắt** hoặc **tạo leakage**
...
<details>
<summary>Tại sao Fe (Iron) lại nguy hiểm đến vậy ở nồng độ ~10¹¹ atom/cm³?</summary>

Fe tạo ra deep level trong bandgap có năng lượng kích hoạt nhỏ (khoảng 0.4 eV từ band edge). Điều này có nghĩa là ở nhiệt độ phòng, Fe rất dễ "bắt" electron (hoặc lỗ trống), làm chúng bị giam trong bẫy (trapping). Kết quả là lifetime carrier giảm drastically — chỉ vài nguyên tử Fe trên khoảng triệu tỷ nguyên tử Si cũng đủ làm lifetime từ microsecond xuống nanosecond.
...
RCA là **phương pháp tiêu chuẩn** loại bỏ cả 3 loại ô nhiễm:
...
<QuickCheck
	client:visible
	question="Tại sao RCA SC2 (dung dịch axit) được dùng sau SC1 (dung dịch kiềm) để làm sạch wafer?"
	options={[
		{ label: "Vì SC1 loại kim loại, SC2 loại hữu cơ", correct: false },
		{ label: "Vì SC1 loại hữu cơ + hạt, SC2 loại kim loại bằng cách pH thấp tạo complexes", correct: true },
		{ label: "Vì chuyên gia không có lý do gì, chỉ là quy tắc", correct: false },
	]}
	explanation="SC1 (dung dịch kiềm: NH₄OH + H₂O₂) loại hữu cơ và hạt bụi thông qua zeta potential. SC2 (dung dịch axit: HCl + H₂O₂) loại kim loại bằng cách tạo complexes với các metal ions ở pH thấp, và H₂O₂ loại kim loại bằng oxidation. Thứ tự này là quan trọng."
/>

## Ô Nhiễm: Kẻ Thù Vô Hình Nhưng Có Thật

**Ô Nhiễm điều khiển toàn bộ yield** của IC hiện đại. Mỗi công đoạn (slicing, epitaxy, photolithography, etch, diffusion, implant, ashing, cleaning) đều có **rủi ro ô nhiễm riêng**. Vì vậy, **kiểm soát chất lượng nước (DI purity), cleanroom, hóa chất, thiết bị** là **cốt lõi của sản xuất bán dẫn hiện đại** — bởi vì "sạch sẽ" không chỉ là một từ đẹp, nó là sự sống và chết của một chip.
